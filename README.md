...
![Historical and cultural monuments of the Kharkiv region of Ukraine](img/01-2-1024x478.png "Historical and cultural monuments of the Kharkiv region of Ukraine")

The map shows only a small part of the monuments (35 objects).

![Filters on the history heritage map](img/02-2-1024x478.png "Filters on the history heritage map")
...
![Sharivsky Park and Landscape Art Monument](img/03-2-1024x555.png "Sharivsky Park and Landscape Art Monument")
...
![Burial mound](img/04-2-1024x485.png "Burial mound")
...
![ESRI Imagery with Labels Basemap](img/05-2-1024x680.png)
